        ...
        if exercise == "Squats":
            ...
            if depth == "TOO HIGH":
                return (
                    ...
                    "— knees are not bending sufficiently."
                )
            ...
            if hip_status == "PIKED UP":
                return (
                    ...
                    "— lower them to form a straight line."
                )
            ...
            if swing == "SWINGING":
                return (
                    ...
                    "during the curl — keep the body still."
                )

            if shoulder == "ELBOW DRIFTING":
                return (
                    "The user's elbow is drifting away "
                    "from their side during the curl."
                )
