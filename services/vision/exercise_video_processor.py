...
class VideoProcessorClass(VideoProcessorBase):
    ...
    def __init__(self):
        ...
        # Latest camera frame waiting for MediaPipe
        ...
        # Process pose at most 10 times per second
        self._process_interval = 1 / 10
    ...
    def _pose_worker(self):
        ...
        while not self._stop_worker:
            ...
            with self._lock:
                ...
                image = self._pending_frame.copy()
            ...
            if result.pose_landmarks:
                ...
                if detector:
                    ...
                    try:
                        ...
                        print("Exercise detector error:", e)
                        continue
    ...
    def recv(self, frame):
        ...
        # -----------------------------------------------------
        # Give latest frame to background worker
        # -----------------------------------------------------
